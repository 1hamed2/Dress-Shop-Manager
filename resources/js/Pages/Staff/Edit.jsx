...
export default function Edit({ staff }) {
    ...
    console.log("Edit Product", staff);
                ...
                <div className="py-12 overflow-y-auto ">
                    <div className="mx-auto sm:px-6 lg:px-8 space-y-6 flex flex-col items-center">
                        <section className="max-w-xl w-full">
                            <header>
                                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">{staff.name}'s Information</h2>

                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    Update {staff.name} account's profile information.
                                </p>
                            </header>
