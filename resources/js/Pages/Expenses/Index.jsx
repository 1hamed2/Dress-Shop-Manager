...
export default function Expenses({ expenses, queryParams, success, updateMsg, deleteMsg }) {
    ...
    const handleSearch = () => {
        ...
        if (/^\d+$/.test(searchQuery)) {
            ...
            updatedParams.title = searchQuery;
            delete updatedParams.id;
        }


        router.get(route('expenses.index', updatedParams));
    };
    ...
    const [expenseDlt, setExpenseDlt] = useState(false);
    ...
    return (
        <>
            <Admin>
                        ...
                        <Card className="h-full w-full">
                                ...
                                <div className="mb-4 flex items-center justify-between gap-8">
                                    ...
                                    <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                                        <Button className="flex items-center gap-3 bg-gray-900" size="sm">
                                            <Link href={route('expenses.create')} className="flex items-center">

                                                <UserPlusIcon strokeWidth={2} className="h-4 w-4" /> Add expense
                                            </Link>
                                        </Button>
                                    </div>
                                </div>
                                ...
                                <table className="mt-4 w-full min-w-max table-auto text-left">
                                        ...
                                        <tr className="bg-slate-800">
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    className="flex items-center justify-between gap-2 font-bold leading-none"
                                                >
                                                    <h2 className="bg-slate-800  text-white p-3 rounded">Title</h2>
                                                    <ChevronUpDownIcon
                                    ...
                                    <tbody>
                                        {expenses.data.length === 0 ? (
                                            ...
                                            expenses.data.map(
                                                (expense) => {
                                                    const isLast = expense === expenses.length - 1;
                                                            ...
                                                            <td className={classes}>
                                                                <div>
                                                                    <Tooltip content="Delete User">
                                                                        <IconButton onClick={(e) => openModal(expense)} variant="text">
                            ...
                            <CardFooter className="flex items-center justify-between border-t border-blue-gray-50 p-4">
                                <Typography variant="small" color="blue-gray" className="font-normal">
                                    Page {expenses.meta.current_page} of {expenses.meta.last_page}
                                </Typography>
                                <div className="flex gap-2">
                                    {expenses.meta.links.map((link) => (
                                        <Link
                                            preserveScroll
                                            href={link.url || ""}
                                            key={link.label}
                ...
                <Modal show={expenseDlt} onClose={closeModal}>
                    <div className="p-6 pointer-events-auto">
                        ...
                        <div className="mt-6 flex justify-end">
                            ...
                            <DangerButton
                                onClick={() => deleteExpense(selectedExpense)} className="ms-3">
                                Delete Expense
                            </DangerButton>
                        </div>
                    </div>
