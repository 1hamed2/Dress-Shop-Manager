...
export default function Sales({ sales, queryParams, success, updateMsg, deleteMsg }) {
    ...
    const handleSearch = () => {
        ...
        router.get(route('sales.index', updatedParams));
    };
    ...
    const [saleDlt, setSaleDlt] = useState(false);
    ...
    const deleteSale = (selectedSale) => {

        // if (!window.confirm('Are you sure you want to delete this sale?')) {
        //     return;
        // }
        if (!selectedSale || !selectedSale.id) {
            alert("Error: No sale selected");
            return;
        }

        console.log("Deleting sale:", selectedSale);

        router.delete(route('sales.destroy', selectedSale.id));
    ...
    return (
        <>
            <Admin>
                        ...
                        <Card className="h-full w-full">
                                ...
                                <div className="mb-4 flex items-center justify-between gap-8">
                                    ...
                                    <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                                        <Button className="flex items-center gap-3 bg-gray-900" size="sm">
                                            <Link href={route('sales.create')} className="flex items-center">
                                ...
                                <table className="mt-4 w-full min-w-max table-auto text-left">
                                        ...
                                        <tr className="bg-slate-800">
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    className="flex items-center justify-between gap-2 font-bold leading-none"
                                                >
                                                    <h2 className="bg-slate-800  text-white p-3 rounded">Product</h2>
                                                    <ChevronUpDownIcon
                                                        onClick={() => sortChanged("product")}
                                                        name="product"
                                                        strokeWidth={2}
                                                        className="h-4 w-4 text-white"
                                                    />
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    className="flex items-center justify-between gap-2 font-bold leading-none"
                                                >
                                                    <h2 className="bg-slate-800  text-white p-3 rounded">Price per unit</h2>
                                                    <ChevronUpDownIcon strokeWidth={2} className="h-4 w-4 text-white" />
                                                </Typography>
                                            </th>
                                            <th
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    className="flex items-center justify-between gap-2 font-bold leading-none"
                                                >
                                                    <h2 className="bg-slate-800  text-white p-3 rounded">Total price</h2>
                                                    <ChevronUpDownIcon strokeWidth={2} className="h-4 w-4 text-white" />
                                                </Typography>
                                            </th>
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    className="flex items-center justify-between gap-2 font-bold leading-none"
                                                >
                                                    <h2 className="bg-slate-800  text-white p-3 rounded">Commission</h2>
                                                    <ChevronUpDownIcon strokeWidth={2} className="h-4 w-4 text-white" />
                                                </Typography>
                                            </th>
                                    ...
                                    <tbody>
                                        {sales.data.length === 0 ? (
                                            ...
                                            sales.data.map(
                                                (sale) => {
                                                    const isLast = sale === sales.length - 1;
                                                            ...
                                                            <td className={classes}>
                                                                <div>
                                                                    <Tooltip content="Delete User">
                                                                        <IconButton onClick={(e) => openModal(sale)} variant="text">
                                                                            <TrashIcon className="h-6 w-6 text-red-500" />
                                                                        </IconButton>
                                                                    </Tooltip>
                                                                    <Tooltip content="Edit User">
                                                                        <IconButton variant="text">
                                                                            <Link href={route('sales.edit', sale)}>
                            ...
                            <CardFooter className="flex items-center justify-between border-t border-blue-gray-50 p-4">
                                <Typography variant="small" color="blue-gray" className="font-normal">
                                    Page {sales.meta.current_page} of {sales.meta.last_page}
                                </Typography>
                                <div className="flex gap-2">
                                    {sales.meta.links.map((link) => (
                                        <Link
                                            preserveScroll
                                            href={link.url || ""}
                                            key={link.label}
                ...
                <Modal show={saleDlt} onClose={closeModal}>
                    <div className="p-6 pointer-events-auto">
                        ...
                        <div className="mt-6 flex justify-end">
                            ...
                            <DangerButton
                                onClick={() => deleteSale(selectedSale)} className="ms-3">
                                Delete Sale
                            </DangerButton>
                        </div>
                    </div>
