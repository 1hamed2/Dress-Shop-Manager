...
import { formatPKR, STOCK_STATUS_CLASS_MAP, STOCK_TEXT_CLASS_MAP } from '@/Constrants';




export default function Products({ products, queryParams, success, updateMsg, deleteMsg }) {
    ...
    const handleSearch = () => {
        ...
        router.get(route('products.index', updatedParams));
    };
    ...
    const [productDlt, setProductDlt] = useState(false);
    ...
    return (
        <>
            <Admin>
                                ...
                                <div className="mb-4 flex items-center justify-between gap-8">
                                    ...
                                    <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                                        <Button className="flex items-center gap-3 bg-gray-900" size="sm">
                                            <Link href={route('products.create')} className="flex items-center">
                                ...
                                <table className="mt-4 w-full min-w-max table-auto text-left">
                                        ...
                                        <tr className="bg-slate-800">
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    className="flex items-center justify-between gap-2 font-bold leading-none"
                                                >
                                                    <h2 className="bg-slate-800  text-white p-3 rounded">Cost Price</h2>
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    className="flex items-center justify-between gap-2 font-bold leading-none"
                                                >
                                                    <h2 className="bg-slate-800  text-white p-3 rounded">Sale Price</h2>
                                                    <ChevronUpDownIcon strokeWidth={2} className="h-4 w-4 text-white" />
                                                </Typography>
                                            </th>
                                            <th
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    className="flex items-center justify-between gap-2 font-bold leading-none"
                                                >
                                                    <h2 className="bg-slate-800  text-white p-3 rounded">Stock</h2>
                                                    <ChevronUpDownIcon
                                                        strokeWidth={2}
                                                        className="h-4 w-4 text-white"
                                                        onClick={() => sortChanged("stock")}
                                                        name="stock"
                                                    />
                                                </Typography>
                                            </th>
                                    ...
                                    <tbody>
                                        {products.data.length === 0 ? (
                                            ...
                                            products.data.map(
                                                (product) => {
                                                    const isLast = product === products.length - 1;
                                                    ...
                                                    return (
                                                        <tr key={product.id}>
                                                            ...
                                                            <td className={classes}>
                                                                ...
                                                                >
                                                                    {product.stock > 0 ? (
                                                                        <span className={`px-2 py-1 rounded text-white text-sm ${STOCK_STATUS_CLASS_MAP['in-stock']} font-semibold`}>
                                                                            {product.stock}
                                                                        </span>
                                                                    ) : (
                                                                        <span className={`px-2 py-1 rounded text-white text-sm ${STOCK_STATUS_CLASS_MAP['out-of-stock']} font-semibold`}>
                                                                            {STOCK_TEXT_CLASS_MAP['out-of-stock']}
                                                                        </span>
                                                                    )}
                                                                </Typography>
                                                            </td>
                                                            <td className={classes}>
                                                                <div>
                                                                    <Tooltip content="Delete User">
                                                                        <IconButton onClick={(e) => openModal(product)} variant="text">
                ...
                <Modal show={productDlt} onClose={closeModal}>
                    <div className="p-6 pointer-events-auto">
                        ...
                        <div className="mt-6 flex justify-end">
                            ...
                            <DangerButton
                                onClick={() => deleteProduct(selectedProduct)} className="ms-3">
                                Delete Product
                            </DangerButton>
                        </div>
                    </div>
